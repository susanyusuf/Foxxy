...
var _type, _to, _data3, _nonce, _gasLimit, _gasPrice, _maxPriorityFeePerGas, _maxFeePerGas, _value, _chainId, _sig, _accessList, _maxFeePerBlobGas, _blobVersionedHashes, _kzg, _blobs, _auths, _blobWrapperVersion, _Transaction_instances, getSerialized_fn;
...
var Block = class {
   ...
   */
  toJSON() {
    const { baseFeePerGas, difficulty, extraData, gasLimit, gasUsed, hash: hash2, miner, prevRandao, nonce, number: number2, parentHash, parentBeaconBlockRoot, stateRoot, receiptsRoot, transactionsRoot, timestamp, transactions } = this;
    return {
      _type: "Block",
...
var _EnsResolver = class _EnsResolver {
  constructor(provider, address, name, supportsWildcard) {
    ...
    __privateSet(this, _supports2544, supportsWildcard != null ? Promise.resolve(supportsWildcard) : null);
  ...
  async getName() {
    return await __privateMethod(this, _EnsResolver_instances, fetch_fn).call(this, "name(bytes32)");
  }
  /**
...
var _Network = class _Network {
  ...
  toString() {
    const plugins = [];
    for (const plugin of __privateGet(this, _plugins).values()) {
...
var AbstractProvider = class {
  ...
  constructor(_network3, options) {
    ...
    __privateAdd(this, _requestRate);
    __privateAdd(this, _requestTimes);
    ...
    __privateSet(this, _requestRate, 0);
    __privateSet(this, _requestTimes, []);
  }
  /**
   *  Limit the number of requests per second. (default: no limit)
   */
  get _requestRate() {
    const value = __privateGet(this, _requestRate);
    if (value == 0) {
      return null;
    }
    return value;
  ...
  set _requestRate(value) {
    ...
    __privateSet(this, _requestRate, getNumber(value));
  }
  get pollingInterval() {
...
_requestRate = new WeakMap();
_requestTimes = new WeakMap();
_options2 = new WeakMap();
_AbstractProvider_instances = new WeakSet();
getDelay_fn = function() {
  let requestRate = __privateGet(this, _requestRate);
  if (requestRate === 0) {
    return 0;
  }
  const requests = __privateGet(this, _requestTimes);
  const now = getTime2();
  requests.push(now);
...
perform_fn = async function(req) {
  ...
  if (timeout < 0) {
    const delay = __privateMethod(this, _AbstractProvider_instances, getDelay_fn).call(this);
    if (delay) {
      await stall(delay);
    }
